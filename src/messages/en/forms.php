...
return [
    ...
    'form_model_email_recipients_hint' => 'When no recipients are provided, the form module won\'t trigger any emails.',
    ...
    'block_hiddenInputValue_help' => 'If this field contains a value, the field will be declared as `hidden` input and the given value will be the input value instead of users input. Note: 0 is not an allowed value',
    'Browser' => '',
    'Created at' => '',
    'Data' => 'Data',
    'Format' => '',
